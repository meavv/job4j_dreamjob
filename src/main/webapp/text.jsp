<html lang="ru"><head>
    ...
    <meta name="description" content="Пример на bootstrap 5: Прайс-лист - пример страницы с ценой, созданной с помощью карт, с пользовательским верхнего и нижнего колонтитула · Версия v5.1.3">
    <title>Прайс-лист | Pricing example for Bootstrap · v5.1.3</title>
